                    ...
                    for(let i=0; i<data.length; i++){
                        ...
                        html += "<tr>" +
                                    ...
                                    "<td><span class='caption' name='jenis_cucian'>" + jenis_cucian +"</span>"+
                                        "<select class='editor' name='jenis_cucian'>" +
                                    ...
                                    "<td><span class='caption' name='paket_cucian'>"+ paket_cucian +"</span>"+
                                        "<select class='editor' name='paket_cucian'>" +
                                    ...
                                    "</td>" +
                                    "<td><span class='caption' name='parfum_cucian'>"+ parfum_cucian +"</span>"+
                                        "<select class='editor' name='parfum_cucian'>" +
                                    ...
                                    "<td><span class='caption' name='subttl'>"+ data[i].sub_ttl +"</span>" +
                                        "<input type='text' value="+data[i].sub_ttl+" class='editor' name='subttl'>"+
                                    "</td>" +
                                    "<td>"+
                                    "<div class='row'>" +
